...
\programming{{Java $\textbullet$ Golang / 5.0}, {Newrelic $\textbullet$ Kibana / 5.2}, {Postgres $\textbullet$ Mongo $\textbullet$ MySQL / 5.4}, {Microservices $\textbullet$ Distributed Systems / 5.4 }, {Kafka $\textbullet$ Event Driven System $\textbullet$ Redis / 5.6}, {Typescript $\textbullet$ Node.js $\textbullet$ PHP $\textbullet$ Python / 5.7 }}
